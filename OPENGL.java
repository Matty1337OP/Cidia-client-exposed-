package goose.yes.exhile.utils.render;
...
public class OPENGL {
    ...
    public static void blurScissor(int right, int top, int left, int down, boolean overlay) {
        ...
        glPushMatrix();
        blurShaderFramebuffer.framebufferRenderExt(Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight, true);
        glPopMatrix();
